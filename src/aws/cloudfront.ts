...
export type BehaviorOptions = Pick<aws.types.input.cloudfront.DistributionOrderedCacheBehavior, 'lambdaFunctionAssociations' | 'originRequestPolicyId' | 'responseHeadersPolicyId'>
